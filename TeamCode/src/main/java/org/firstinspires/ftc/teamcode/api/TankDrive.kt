...
object TankDrive : API() {
   ...
   // lateinit var preOuttake2: Servo
    ...
    override fun init(opMode: OpMode) {
        ...
        leftDrive = this.opMode.hardwareMap.get(DcMotor::class.java, "leftDrive")
        ...
        //preOuttake1 = this.opMode.hardwareMap.get(Servo::class.java, "preOuttake1")
        //preOuttake2 = this.opMode.hardwareMap.get(Servo::class.java, "preOuttake2")
